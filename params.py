...
_PAPER = dict(
    ...
    N=256, Q=8365057, K=4, L=4,          # q = 2^9*16338+1 = 2^15*255+9217, prime, q = 1 (mod 2n)
    OMEGA=60,
    # sigma_w, sigma~_w, sigma_wit (Appendix E derives these from
    # M_s=M_ps=M_wit=1.3 and target Renyi-divergence errors
    # eps_s=eps_ps<=2^-68, eps_wit<=2^-194).
    SIGMA_Y=2 ** 16.5, SIGMA_Y_TILDE=2 ** 16.47, SIGMA_WIT=2 ** 11.41,
    ...
    B_WIT=2 ** 17.3, B_PROXYSIGN=2 ** 22.99, B_SIGN=2 ** 23.02,
)
